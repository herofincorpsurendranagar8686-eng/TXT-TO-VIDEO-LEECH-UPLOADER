...
FORCE_SUB_CHANNEL = environ.get("FORCE_SUB_CHANNEL", "-1003519201383")  # Channel username without @, 
FORCE_SUB_CHANNEL_LINK = environ.get("FORCE_SUB_CHANNEL_LINK", "https://t.me/jadeja789")  # Channel link
